...
use crate::policy::{AnyPolicyDyn, AnyPolicySerialize, AnyPolicyTrait, AnyPolicyable, NoPolicy, Policy, PolicyAnd, PolicyDyn, PolicyDynInto, PolicyDynRelation, PolicyOr};
...
mod __validation {
    pub fn example<P: super::AnyPolicyClone>(_p: P) {}
    pub fn test_me(p: super::AnyPolicyDyn<dyn super::AnyPolicyClone>) {
        example(p)
    }
}
