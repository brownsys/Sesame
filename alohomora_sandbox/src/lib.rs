...
pub fn sandbox_preamble<'a, T: std::fmt::Debug, R: Swizzleable, F: Fn(T) -> R>(
    ...
    println!("im in the fucking sandbox");
...
pub trait AlohomoraSandbox<'a, 'b, T, R> 
    where 
        ...
        R: Swizzleable
{
    fn invoke(arg: <T as Sandboxable>::InSandboxUnswizzled, sandbox_index: usize) -> *mut R::Unswizzled;
}
...
macro_rules! invoke_sandbox {
    ($functor:ident, $arg:ident, $arg_ty:ty, $ret_ty:ty, $sandbox_index:ident) => {
        ...
        // Return.
        return ret as *mut <$ret_ty as ::alohomora_sandbox::copy::Swizzleable>::Unswizzled;
