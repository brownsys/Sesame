CREATE TABLE users (email varchar(255), apikey varchar(255), is_admin tinyint, pseudonym varchar(255), gender varchar(255), age int, ethnicity varchar(255), is_remote tinyint, education varchar(255), PRIMARY KEY (apikey));
