...
fn check_crate(cx: &LateContext<'_>) {
    let path: &[&str] = &vec!["sesame_sandbox", "FastTransfer"];
...
#[test]
fn sesame_sandboxable_legal() {
    dylint_testing::ui_test_example(
        env!("CARGO_PKG_NAME"),
        "sesame_sandbox_transfer_legal"
    );
}

#[test]
fn sesame_sandboxable_illegal() {
    dylint_testing::ui_test_example(
        env!("CARGO_PKG_NAME"),
        "sesame_sandbox_transfer_illegal"
    );
}
