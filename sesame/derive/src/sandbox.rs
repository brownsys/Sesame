...
pub fn sandbox_impl(input: ItemFn) -> TokenStream {
    ...
    quote! {
        ...
        #[doc = "Library implementation of SesameSandbox. Do not copy this docstring!"]
        impl ::sesame_sandbox::SesameSandbox<#arg, #ret> for #function_name {
        ...
        pub extern "C" fn #function_name_sandbox(arg: *mut std::ffi::c_void) -> *mut std::ffi::c_void {
            <#function_name as ::sesame_sandbox::SesameSandbox<#arg, #ret>>::sandbox_preamble(arg)
        }
    }
}
...
pub fn derive_fast_transfer_impl(
    ...
    Ok(quote! {
        ...
        pub struct #unswizzled_name #impl_generics #where_clause {
            #(pub #field_name: <#field_type as ::sesame_sandbox::FastTransfer>::TypeInSandbox,)*
        }

        #[automatically_derived]
        #[doc = "Library implementation of FastTransfer. Do not copy this docstring!"]
        impl #impl_generics ::sesame_sandbox::FastTransfer for #struct_name #type_generics #where_clause {
            #[cfg(not(target_arch = "wasm32"))]
            type TypeInSandbox = #unswizzled_name #type_generics;

            #[cfg(not(target_arch = "wasm32"))]
            fn into_sandbox(outside: Self, sandbox: ::sesame_sandbox::SandboxInstance) -> Self::TypeInSandbox {
                #unswizzled_name {
                    #(#field_name2: ::sesame_sandbox::FastTransfer::into_sandbox(outside.#field_name2, sandbox),)*
                }
            }

            #[cfg(not(target_arch = "wasm32"))]
            fn out_of_sandbox(inside: &Self::TypeInSandbox, sandbox: ::sesame_sandbox::SandboxInstance) -> Self {
                #struct_name {
                    #(#field_name3: ::sesame_sandbox::FastTransfer::out_of_sandbox(&inside.#field_name3, sandbox),)*
                }
            }
        }
    })
