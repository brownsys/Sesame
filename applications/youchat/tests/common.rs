...
pub(crate) fn response_contains(
    ...
    if portion == ResponsePortion::RecievedChats {
        response_string = response_string
            [response_string.find("Recieved Chats").unwrap()..response_string.len()]
            .to_string();
    } else if portion == ResponsePortion::SentChats {
        response_string = response_string[response_string.find("Sent Chats").unwrap()
            ..response_string.find("Recieved Chats").unwrap()]
            .to_string();
    }
