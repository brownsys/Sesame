...
impl<'a> ServiceGenerator<'a> {
    ...
    fn impl_client_rpc_methods(&self) -> TokenStream2 {
        ...
        let method_idents_str = method_idents.iter().map(|x| x.to_string()).collect::<Vec<_>>();
        ...
        quote! {
            ...
            // {
                ...
                #(
                    #[allow(unused)]
                    #( #method_attrs )*
                    #vis fn #method_idents<InputLocalPolicy: ::alohomora::policy::PolicyInto<#target_policies> + 'static + Send, OutputLocalType : ::alohomora::tarpc::traits::TahiniTransformFrom<#return_types>+ Send>(&self, ctx: ::tarpc::context::Context, #arg_pats : ::alohomora::bbox::BBox<#bbox_types, InputLocalPolicy>)
                        // -> impl ::core::future::Future<Output = ::core::result::Result<<#return_types as ::alohomora::tarpc::traits::TahiniTransform<OutputLocalPolicy>>::Target, ::tarpc::client::RpcError>> + '_ {

                        -> impl ::core::future::Future<Output = ::core::result::Result<OutputLocalType, ::tarpc::client::RpcError>> + '_ {
                        ...
                        async move {
                            match resp.await? {
                                // #response_ident::#camel_case_idents(msg) => ::core::result::Result::Ok(<#return_types as ::alohomora::tarpc::traits::TahiniTransform<OutputLocalPolicy>>::transform_policy(msg, &context).map_err(|_| ::tarpc::client::RpcError::Shutdown)?),
                                #response_ident::#camel_case_idents(msg) => ::core::result::Result::Ok(OutputLocalType::transform_from(msg, &context).expect("Couldn't transform output policy")),
                                _ => ::core::unreachable!(),
                            }
                        }
                    }
