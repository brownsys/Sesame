...
pub fn sandbox_impl(input: ItemFn) -> TokenStream {
    ...
    quote! {
        ...
        extern "C" {
            pub fn #invoke_sandbox_function_name_c(arg: *const ::std::os::raw::c_char) -> *mut ::std::os::raw::c_char;
        }
        ...
        pub extern "C" fn #function_name_sandbox(arg: *const ::std::os::raw::c_char) -> *mut ::std::os::raw::c_char {
