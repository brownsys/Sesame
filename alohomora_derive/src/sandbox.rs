...
pub fn sandbox_impl(input: ItemFn) -> TokenStream {
    ...
    quote! {
        ...
        extern "C" {
            pub fn #invoke_sandbox_function_name_c(arg: *const u8, size: u32) -> ::alohomora_sandbox::sandbox_out;
        }
        ...
        pub extern "C" fn #function_name_sandbox(arg: *const u8, size: u32) -> *mut u8{
