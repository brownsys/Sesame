...
pub fn sandbox_impl(input: ItemFn) -> TokenStream {
    ...
    quote! {
        ...
        extern "C" {
            pub fn #invoke_sandbox_function_name_c(arg: *mut std::ffi::c_void, size: usize) -> ::alohomora_sandbox::sandbox_out;
        }
        ...
        impl<'__a, '__b> alohomora_sandbox::AlohomoraSandbox<'__a, '__b, #arg, #ret> for #function_name {
            // fn invoke(arg: <#arg as ::alohomora_sandbox::swizzle::Swizzleable>::Unswizzled, sandbox_index: usize) -> ::alohomora_sandbox::FinalSandboxOut<#ret> {
            fn invoke(arg: <#arg as ::alohomora_sandbox::swizzle::Swizzleable>::Unswizzled, sandbox_index: usize) -> ::alohomora_sandbox::FinalSandboxOut<#ret> {
        ...
        pub extern "C" fn #function_name_sandbox(arg: *mut std::ffi::c_void, slot: usize) -> *mut u8{
            alohomora_sandbox::sandbox_preamble(#function_name, arg, slot)
        }
